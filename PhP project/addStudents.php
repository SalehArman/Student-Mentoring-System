...
<div class = "container">
  ...
  <div class="col-md-6">
    <form action="" method="post" name="Login_Form" class="form-signin">       
        <h3 class="form-signin-heading">Add Student Information</h3>
        <hr class="colorgraph"><br>        
       <a href="import.php" class="btn btn-success btn-lg" role="button">Import</a>
       

       <a href="addStudentsInformation.php" class="btn btn-info btn-lg" role="button">Add Student Information</a>
    </form> 
